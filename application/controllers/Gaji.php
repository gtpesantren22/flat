...
class Gaji extends CI_Controller
{
    ...
    public function detail($id)
    {
        ...
        // $datagaji = $this->model->getBy('gaji_detail', 'gaji_id', $id)->result();
        ...
        //         $data['gaji_list'][] = [
        //             'nama' => $key->nama,
        //             'satminkal' => $key->satminkal,
        //             'golongan' => $key->golongan,
        //             'jabatan' => $key->jabatan,
        //             'sik' => $key->sik,
        //             'ijazah' => $key->ijazah,
        //             'tmt' => $key->tmt,
        //             'gapok' => $gapok && in_array('gapok', $payments) ? $gapok->nominal : 0,
        //             'fungsional' => $fungsional && in_array('fungsional', $payments) ? $fungsional->nominal : 0,
        //             'kinerja' => $kinerja && in_array('kinerja', $payments) ? $kinerja->nominal : 0,
        //             'struktural' => $struktural && in_array('struktural', $payments) ? $struktural->nominal : 0,
        //             'bpjs' => $bpjs && in_array('bpjs', $payments) ? $bpjs->nominal : 0,
        //             'walas' => $walas && in_array('walas', $payments) ? $walas->nominal : 0,
        //             'penyesuaian' => $penyesuaian && in_array('penyesuaian', $payments) ? $penyesuaian->sebelum - $penyesuaian->sesudah : 0,
        //         ];
        //     }
        // }
    ...
    public function tambah()
    {
        ...
        $this->model->tambah('gaji', ['gaji_id' => $id, 'bulan' => $bulan, 'tahun' => $tahun, 'tapel' => $this->tahun]);
