...
<head>
    ...
    <!-- <link rel="stylesheet" href="<?= base_url() ?>assets/vendor/fonts/boxicons2.css" /> -->
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>

    <!-- Core CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/vendor/css/core-new.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="<?= base_url() ?>assets/vendor/css/theme-default-new.css" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="<?= base_url() ?>assets/css/demo-new.css" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/vendor/libs/perfect-scrollbar/perfect-scrollbar-new.css" />
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">FlatApp</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Layouts -->
                    <li class="menu-item <?= isset($sub) && $sub == 'master'  ? 'active open' : '' ?>">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-layout"></i>
                            <div data-i18n="Layouts">Data Pokok</div>
                        </a>

                        <ul class="menu-sub">
                            <li class="menu-item <?= $judul == 'Lembaga' ? 'active' : '' ?>">
                                <a href="<?= base_url('lembaga') ?>" class="menu-link">
                                    <div data-i18n="Without menu">Data Lembaga/Satminkal</div>
                                </a>
                            </li>
                            <li class="menu-item <?= $judul == 'Golongan' ? 'active' : '' ?>">
                                <a href="<?= base_url('golongan') ?>" class="menu-link">
                                    <div data-i18n="Without navbar">Data Golongan</div>
                                </a>
                            </li>
                            ...
                            <li class="menu-item <?= $judul == 'Jabatan' ? 'active' : '' ?>">
                    ...
                    <li class="menu-item <?= $judul == 'Guru' ? 'active' : '' ?>">
                        <a href="<?= base_url('guru') ?>" class="menu-link">
                            ...
                            <div data-i18n="Analytics">Guru/Karyawan</div>
                        </a>
                    </li>
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item <?= $judul == 'Tunjangan Struktural' ? 'active' : '' ?>">
                                <a href="<?= base_url('struktural') ?>" class="menu-link">
                                    ...
                                    <div data-i18n="Fluid">Tunjangan Struktural</div>
                                </a>
                            </li>
